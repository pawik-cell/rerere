...
$sql = "SELECT NPM, Nama, Jurusan, Waktu_Kehadiran FROM absen ORDER BY Waktu_Kehadiran DESC";
...
<head>
    ...
    <title>Data Absensi Mahasiswa 3.1</title>
    <style>
        body {
        ...
        .table-container {
            max-height: 300px; /* Tinggi maksimum area tabel */
